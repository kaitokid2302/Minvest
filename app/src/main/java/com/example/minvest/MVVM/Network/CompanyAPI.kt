...
interface CompanyAPI {
    ...
    fun _getPrice(@Header("X-RapidAPI-Key") token: String = Credentials.token, @Header("X-RapidAPI-Host") xRapidApiHost: String = Credentials.host, @Query("symbol") symbol: String): Response<Company>
